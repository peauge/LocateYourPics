...
export class EditPassword extends React.Component{
  ...
  handleSubmit() {
    AccountActions.updatePassword(this.state);
  }
  ...
  handleChange(field) {
    this.setState({passwordForm : field});
  }
    ...
    console.log("render EDIT PASSWORD:", this.state);
      ...
      <Text style={{alignSelf : "center", fontSize : 18, color : "white", marginTop : 5, marginBottom : 5}}>{I18n.t('Setting')['upPass']}</Text>
      <SignForm
        formType={5}
